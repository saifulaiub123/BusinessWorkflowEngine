...
namespace BWE.Application.Service
{
    public class ScriptService : IScriptService
    {
        ...
        {
            var data = (await _scriptRepository.GetAll(x => !x.IsDeleted && x.CreatedByUser.StatusId != 0, include => include.Server, includes => includes.CreatedByUser))
        ...
        {
            var sharedScript = (await _scriptUserPermissionRepository.GetAll(x => x.UserId == userId && !x.Script.IsDeleted && x.Script.CreatedByUser.StatusId != 0, 
        ...
        {
            var sharedScript = (await _scriptUserPermissionRepository.GetAll(x => x.ScriptId == scriptId && !x.Script.IsDeleted && x.User.StatusId != 0, 
        ...
        public async Task UpdateScript(UpdateScriptModel script)
        {
            ...
            if(existingScript != null)
            {
                ...
                existingScript.Parameter = script.Parameter;
