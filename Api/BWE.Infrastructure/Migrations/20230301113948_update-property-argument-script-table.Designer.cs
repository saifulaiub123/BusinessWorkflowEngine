...
namespace BWE.Infrastructure.Migrations
{
    ...
    [Migration("20230301113948_update-property-argument-script-table")]
    partial class updatepropertyargumentscripttable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BWE.Domain.DBModel.ScriptHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BWE.Domain.DBModel.ScriptHistory", b =>
                {
                    b.HasOne("BWE.Domain.DBModel.ApplicationUser", "CreatedByUser")
                        ...
                        .HasForeignKey("BWE.Domain.DBModel.ScriptHistory", "CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("BWE.Domain.DBModel.ApplicationUser", "UpdateByUser")
                        ...
                        .HasForeignKey("BWE.Domain.DBModel.ScriptHistory", "UpdatedBy")
                        .OnDelete(DeleteBehavior.Restrict);
