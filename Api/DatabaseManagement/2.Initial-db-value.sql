...
--Inseret initial Admin User
SET IDENTITY_INSERT [dbo].[AspNetUsers] ON 

INSERT [dbo].[AspNetUsers] ([Id],[FirstName], [LastName], [StatusId], [UserName], [NormalizedUserName], [Email], [NormalizedEmail], [EmailConfirmed], [PasswordHash], [SecurityStamp], [ConcurrencyStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount], [IsDeleted]) VALUES (100, N'Admin', N'Admin', 1, N'admin@gmail.com', N'ADMIN@GMAIL.COM', N'admin@gmail.com', N'ADMIN@GMAIL.COM', 0, N'AQAAAAEAACcQAAAAEN+6Pi7txgd+ckECxDngyx1elKNbxJ+QbJeSz5md/ANMXw1mMWkx35g7lffGZoS6PQ==', N'6IRPRU6WDHAAMTVFX3S7ROJCZGJNBWGC', N'f72adeaa-0c2b-4240-887f-f84884d9f99c', NULL, 0, 0, NULL, 1, 0, 0)

SET IDENTITY_INSERT [dbo].[AspNetUsers] OFF

--Set user role
INSERT INTO AspNetUserRoles(UserId, RoleId) VALUES(100,1)
